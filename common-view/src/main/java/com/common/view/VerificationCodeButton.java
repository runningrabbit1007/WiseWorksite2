...
public class VerificationCodeButton extends Button {
	...
	public void startLoad() {
		...
		setAttribute();
		this.setText(mcontext.getString(R.string.art_loading));
	}
	...
	private CharSequence formatDuring(int mTime) {
		if (mTime < 10) {
			return "0" + mTime + mcontext.getString(R.string.art_second);
		}
		return mTime + mcontext.getString(R.string.art_second);
	}
...
//			}
			...
			String trimStr = removeAllSpace(mBindPhoneEt.getText().toString());
