 ...
 * 
 */
public class AreaListItemProxy<T> {
	...
	public AreaListItemProxy(ListView mProxyView) {
...
//		setShowParams(mProxyView,mAdapter);
	}
...
//		ArrayList<T> getParams(ListView proxyView);
		...
		void setShowParams(ListView proxyView,CommonAdapter<T> mAdapter);
	}
}