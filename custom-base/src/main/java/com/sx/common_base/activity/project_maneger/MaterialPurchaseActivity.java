...
public class MaterialPurchaseActivity extends BaseRequestUrlActivity {
    ...
    public void initTitle() {
        ...
        mTitleBar.setRightImageClick1(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext,MaterialPurchaseAddActivity.class);
    ...
    public void initData() {
        ...
        mlistView.setAdapter(new MaterialPurchaseAdapter(mContext,strings));
