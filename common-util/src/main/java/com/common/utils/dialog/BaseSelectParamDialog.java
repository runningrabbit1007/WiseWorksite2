 ...
 * Desc   : 一个参数选择Dialog
 */
public abstract class BaseSelectParamDialog implements OnTouchListener,
    ...
    public BaseSelectParamDialog(Context context, TextView proxyView) {
