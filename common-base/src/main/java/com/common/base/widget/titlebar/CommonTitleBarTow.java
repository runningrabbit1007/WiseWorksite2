 ...
 * 项目头部整体bar
 */
public class CommonTitleBarTow extends RelativeLayout{
    ...
    public CommonTitleBarTow(Context context){
        this(context, null);
    }

    public CommonTitleBarTow(Context context, AttributeSet attrs){
        this(context, attrs, 0);
    }

    public CommonTitleBarTow(Context context, AttributeSet attrs, int defStyle){
    ...
    private void initView(){
        View view = ViewUtil
                .getView(mContext, R.layout.layout_common_title_bar_tow, this);
        ...
        mRightText1 = (TextView) view.findViewById(R.id.img_btn1_text);
        mRightImg2 = (ImageView) view.findViewById(R.id.img_btn2);
        mRightText2 = (TextView) view.findViewById(R.id.img_btn2_text);
        rightBtn1 = (LinearLayout) view.findViewById(R.id.right_btn1_ll);
        rightBtn2 = (LinearLayout) view.findViewById(R.id.right_btn2_ll);
    ...
    public void setRightText1(String str){
        mRightText1.setVisibility(View.VISIBLE);
        mRightText1.setText(str);
    }
    ...
    public void setRightImageClick1(OnClickListener pOnClickListener){
        rightBtn1.setOnClickListener(pOnClickListener);
    }
    ...
    public void setRightImageClick2(OnClickListener pOnClickListener){
        rightBtn2.setOnClickListener(pOnClickListener);
    }
