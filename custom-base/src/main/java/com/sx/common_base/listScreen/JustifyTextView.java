...
public class JustifyTextView extends android.support.v7.widget.AppCompatTextView {
	...
	private HeightMeasureLisenter mLisenter;
	public interface HeightMeasureLisenter {
		void heightMeasured(int height);
	}
	public void setOnHeightMeasureLisenter(HeightMeasureLisenter lisenter){
	...
	protected void onDraw(Canvas Canvas) {
		...
		if(mLineY!=0){
			if(mLisenter!=null){
				mLisenter.heightMeasured(mLineY);
			}
		}
	}
