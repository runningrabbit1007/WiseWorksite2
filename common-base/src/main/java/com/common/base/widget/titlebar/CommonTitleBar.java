...
public class CommonTitleBar extends RelativeLayout{
    ...
    private void initView(){
        View view = ViewUtil
                .getView(mContext, R.layout.layout_common_title_bar, this);
    ...
    public void setRightTextVisibility(boolean isShow){
        if(isShow) {
            mCustomerRightButton.setVisibility(VISIBLE);
        }else{
            mCustomerRightButton.setVisibility(INVISIBLE);
        }
    }
     ...
     * @param pOnClickListener
     */
    public void setLeftTextClick(OnClickListener pOnClickListener){
        mCustomerLeftButton.setOnClickListener(pOnClickListener);
    }
