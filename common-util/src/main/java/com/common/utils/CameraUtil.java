...
/**
 * Created by yonggege on 2017/7/25.
 */
...
//    public static boolean
//
//    createFile(String fileNameWithPath)
//
//    {
...
//                public static boolean 
//
//    createFile(String dirPath, String fileName) 
//
//    {  
...
//
//    createFileName(String fileType) 
//
//    {  
//        String fileName = "";  
...
//                public static void 
//
//    savePhotoToPath(String fileNameWithPath, Bitmap bitmap) 
//
//    {  
//        if (isSDExit()) {  
//            File file = new File(fileNameWithPath);  
...
//                public static boolean 
//
//    deleteFile(String dirPath, String fileName) 
//
//    {  
//        File file = new File(dirPath, fileName);  
//        if (!file.exists()) {  
...
//                public static void 
//
//    updateSystemMedia(Context context) 
//
//    {  
...
//                public static Intent 
//
//    cropPicture(Uri inUri, Uri outUri) 
//
//    {  
