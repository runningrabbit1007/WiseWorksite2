 ...
 *
 */
public class SafetyInspectionDetailAddActivity extends BaseRequestUrlActivity {


    @Override
    public int getContentViewId() {
        return R.layout.activity_safety_inspection_detail_add;
    }
