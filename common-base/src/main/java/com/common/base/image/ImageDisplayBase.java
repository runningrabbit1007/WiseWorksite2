...
public abstract class ImageDisplayBase {
    ...
    public void loadKeepScaleImage(ImageView imageView, Object resource){
        display(imageView, resource, FileType.KEEP_SCALE, 0, 0);
    }

    public void loadKeepScaleImage(ImageView imageView, Object resource,int errorResource){
        display(imageView, resource, FileType.KEEP_SCALE, 0, errorResource);
    }

    public void loadKeepScaleImage(ImageView imageView, Object resource, int placeHolder, int errorResource){
        display(imageView, resource, FileType.KEEP_SCALE, placeHolder, errorResource);
    }
