package com.sx.common_base.widget;
...
import com.sx.common_base.util.TimeUtil;
import com.sx.common_base.util.ToastUtils;
...
//        END_YEAR = year;
    ...
    private SpannableString makeFormatContent(String priFix, String content){
        ...
        spannableString.setSpan(new ForegroundColorSpan(mContext.getResources().getColor(R.color.text_first_color)),
