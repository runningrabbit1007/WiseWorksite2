...
public abstract class PermissionFragmentActivity extends BaseRequestUrlFragmentActivity implements PermissionListener, IRequestPermission, RationaleListener {
    ...
    public void onRequestPermission(String[] pStrings, int requestCode) {
        AndPermission.with(PermissionFragmentActivity.this).requestCode(requestCode).permission(pStrings).rationale(this).send();
    }
    ...
    final protected void showPermissionMsg(int requestCode, final boolean isMiui, final Rationale pRationale) {
        ...
        new AlertDialog.Builder(PermissionFragmentActivity.this)
                .setTitle(title)
                .setMessage(msg)
