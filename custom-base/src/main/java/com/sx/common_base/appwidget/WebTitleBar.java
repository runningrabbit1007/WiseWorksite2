...
public class WebTitleBar extends RelativeLayout {
	 ...
	 * 左边和右边字体大小
	 */
	private int mRightAndReturnTextSize = 16;
	...
	private CommonTitleBar.TitleCilckLisenter mLisenter;

	public void setOnTitleClickLisenter(CommonTitleBar.TitleCilckLisenter lisenter){
	...
	public WebTitleBar(Context context, AttributeSet attrs, int defStyle){
	...
	private void initAttributeSet(AttributeSet attrs){
		TypedArray array = mContext.obtainStyledAttributes(attrs,
				com.common.base.R.styleable.GENERAL_TITLE_BAR);
		if(!isInEditMode()){
			int barBackground = array.getResourceId(
					com.common.base.R.styleable.GENERAL_TITLE_BAR_barBackground, 0);
			if(barBackground != 0){
				mLayout.setBackgroundResource(barBackground);
			}
			mRightAndReturnTextSize = array.getDimensionPixelSize(
					com.common.base.R.styleable.GENERAL_TITLE_BAR_rightAndReturnTextSize,
			...
			mMiddleTextSize = array.getDimensionPixelSize(
					com.common.base.R.styleable.GENERAL_TITLE_BAR_middleTextSize, mMiddleTextSize);
			mComtopTitle.setTextSize(mMiddleTextSize);
			mRetrunIsClick = array.getBoolean(
					com.common.base.R.styleable.GENERAL_TITLE_BAR_returnIsClick, true);
			if(mRetrunIsClick){
	...
	private void initView(){
		View view = ViewUtil
				.getView(mContext, com.common.base.R.layout.layout_common_title_bar, this);
		mLayout = (RelativeLayout) view.findViewById(com.common.base.R.id.common_top_root);
		mComtopReturn = (ImageView) view.findViewById(com.common.base.R.id.comtop_return);
		mComtopBack = (ImageView) view.findViewById(com.common.base.R.id.comtop_back);
		mImgTitlebac = (ImageView) view.findViewById(com.common.base.R.id.img_title_bac);
		mComtopTitle = (TextView) view.findViewById(com.common.base.R.id.comtop_title);
		mCustomerLeftButton = (TextView) view
				.findViewById(com.common.base.R.id.customer_left_btn);
		mCustomerRightButton = (TextView) view
				.findViewById(com.common.base.R.id.customer_right_button);
		mRightImg1 = (ImageView) view.findViewById(com.common.base.R.id.img_btn1);
		mRightImg2 = (ImageView) view.findViewById(com.common.base.R.id.img_btn2);
		mDotBadgeView = (MaterialBadgeTextView) view.findViewById(com.common.base.R.id.tips_title);
		mBacView = view.findViewById(com.common.base.R.id.bac_view);
	...
	public void steTitleSize(float size){
