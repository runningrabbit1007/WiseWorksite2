...
public class UsingMaterialActivity extends BaseRequestUrlActivity {
    ...
    public void initTitle() {
        ...
        mTitleBar.setRightImageClick1(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext,UsingMaterialAddActivity.class);
    ...
    public void initData() {
        ...
        mlistView.setAdapter(new UsingMaterialAdapter(mContext,strings));
