...
public abstract class PermissionFragment extends BaseRequestUrlFragment implements PermissionListener, IRequestPermission, RationaleListener {
    ...
    public void onRequestPermission(String[] pStrings, int requestCode) {
        AndPermission.with(PermissionFragment.this).requestCode(requestCode).permission(pStrings).rationale(this).send();
    }
